...
if __name__ == "__main__":
    logging.basicConfig(format="%(asctime)s - %(module)s - %(levelname)s - %(message)s", level=logging.INFO, filename='/data/wzh/paperproject/Ms/Ms-PoE/utils/lost_in_the_middle/result.log', filemode='a')
