...
class MutiLlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.is_causal = True
        self.small_scale = config.small_scale
        self.big_scale = config.big_scale
    ...
    def _init_rope(self):
        #index放大
        self.rotary_emb1 = LlamaLinearScalingRotaryEmbedding(self.head_dim, max_position_embeddings=self.max_position_embeddings, scaling_factor=self.big_scale)
        #index减少
        self.rotary_emb2 = LlamaLinearScalingRotaryEmbedding(self.head_dim, max_position_embeddings=self.max_position_embeddings, scaling_factor=self.small_scale)
        # #index放大
        ...
        # print("12345678933333333333333333333")
