...
if __name__ == '__main__':
    ...
    #读取日志文件
    population_all_data = json.load(open("/data/wangzh/middle_rope/log/part_evolution/log-20250121-183821.json","r"))["population"]

    for population_data in population_all_data:
        points = np.array(population_data[0])
        # 贝塞尔曲线
