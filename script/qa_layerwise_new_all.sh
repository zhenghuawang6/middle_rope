cuda="1,3"
num_pro=2
for answer_idx in 10 5 1;
do
CUDA_VISIBLE_DEVICES=$cuda accelerate launch --num_processes=$num_pro --main_process_port=29508 ../src/inference_qa_layerwise_new_all.py \
