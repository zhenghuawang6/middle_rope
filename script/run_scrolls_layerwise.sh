...
# python ../src/utils/zero_scrolls/experiments/hf/run_hf_model_layerwise.py --model-name=lmsys/vicuna-7b-v1.5-16k
python ../src/utils/zero_scrolls/experiments/hf/run_hf_model_layerwise.py  --model_name lmsys/vicuna-7b-v1.5 \
--generations_dir layerwise_generation/